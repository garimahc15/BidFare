...
<script type='text/javascript'>
    ...
    <div class="left_content">
      <div class="title_box">BidFare</div>
      <ul class="left_menu">
		<div class="mandm">
		<li class="even"><a>Mission & Objectives</a></li>
		</div>
		<div class="org">
        <li class="odd"><a>News</a></li>
		</div>
		<div class="feed">
	...
	<!-- Mission and Vision -->
		<div class="mandms">
		<div class="center_title_bar">Mission and Vision</div>
		<div class="prod_box_big">
			<div class="top_prod_box_big"></div>
			<div class="center_prod_box_big">
							<div class="welc"><center>Welcome to BidFare</center></div>
			<div class='logreg'>
					<div class="loginb">
			...
			<div class="contact_form">
				<div id="form_row1a">
				  	<span class="blue">&nbsp; &nbsp; Bidfare's purpose is to give and provide excelled services, creating an appropriate online auction webpage that promotes different kinds of products.</span>                
				</div>
			</div>
		 ...
		 <div class="organization">
		  ...
		  <div class="prod_box_big">
			<div class="top_prod_box_big"></div>
			<div class="center_prod_box_big">
							<div class="welc"><center>Welcome to BidFare's News Section</center></div>
							<div class='logreg'>
					<div class="loginb">
						<div class="top_prod_box"></div>
		 ...
		 <div class="companyfeedback">
		  ...
		  <div class="prod_box_big">
			...
			<div class="center_prod_box_big">
							...
							<div class="welcsub"><center><p>Welcome to BidFare User Agreement. This agreement describes the terms and conditions
			 ...
			 <div class='companyfeedback'>
				 ...
				 <span class="blue"><li>Joining BidFare cost Rs. 300 for the membership. Our then current Fees and Credit Policies for selling
				 item are available at BidFare. Unless otherwise stated, all fees are quoted in Indian Rupee. You are responsible for paying
		 ...
		 <div class="developer">
		  ...
		  <div class="prod_box_big">
			...
			<div class="center_prod_box_big">
							...
							<div class="welcsub"><center><p>Introduction to Developers <p></center></div>
				<div class='logreg'>
					<div class="loginb">
						<div class="top_prod_box"></div>
						<div class="center_prod_box">
				...
				<div class='developer'>
					<div class="loginc">
					<br><br>					
					<span class="blue">Garima Chahar</span>   
					<br><br><br><br><br>				
					<span class="blue">Raman Soni</span> 
					<br><br><br><br><br>					
					<span class="blue">Yashika Baan</span> 					
				</div>
			  </div>
			   </div>
			<div class="bottom_prod_box_big"></div>
