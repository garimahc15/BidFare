...
//shows latest products-----
	...
	function latest($conn){
		...
		while($row = mysqli_fetch_array($query))
		{
			...
			$highname = isset($namea['userid']) ? $namea['userid'] : 0;
			echo "<div class='prod_box'>";
				echo "<div class='top_prod_box'></div>";
				echo "<div class='center_prod_box'>";
				...
				echo "<div class='prod_price'><span>Start Bid at: </span> <span class='price'>Rs ".$row['startingbid']."</span><br />
...
function account($conn){
	if ($_SESSION['logged'] != 'guest'){
		...
		if($_SESSION['logged']=='notactive'){
			echo '<li><a href="sendemail.php" class="nav3">Activate Account</a></li>';
		}
		echo '<li><a href="myaccount.php" class="nav3">View Account</a></li>
