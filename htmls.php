<?php
	function headhtml(){
	  ...
	  <script type="text/javascript">
			...
			<div id="main_container">
			  ...
			  <div id="header">
				<div id="logo"> <a href="#"><img src="images/logobidfare.png" alt="" border="0" width="277" height="170" /></a> </div>
	...
	function foothtml(){
		echo ' <div class="footer">
				<div class="left_footer"> <img src="images/logobidfare.png" alt="" width="170" height="85"/> </div>
