           ...
           <div class="product_img_big">
			...
			<div class="details_big_box">
				...
				<?php
							...
							$hibidder = isset($highestbiddera['bidder']) ? $highestbiddera['bidder'] : 0;
							
							if($_SESSION['logged']=='notactive'||$_SESSION['logged']=='guest'){
								echo"<span class='blue'><p> Only those who have an activated account can access to this and participate. Please Log-In or Register</p></br><h2>To Activate Account, go to Account option on the menubar. Then click on Activate Account to receive an activation link on your email id. Later, just click on the link sent to you via email. <br> Once verified, you need to to re-Login to your account in order to start bidding.  </h2></span>";
							}else{
							...
							echo"</span>
								...
								echo isset($namea['userid']) ? $namea['userid'] : 0 ;?>
								<?php echo"</span><br /><br />
