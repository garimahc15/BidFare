...
if (isset($_POST['prodsave'])){
	...
	$fdate = time() + ($auctiontime * 24 * 60 * 60);
	...
	mysqli_query($conn, "INSERT INTO products(prodname,categoryid,prodescription,startingbid,prodimage,regularprice,dateposted,duedate,status) 
						VALUES ('$prodname','$category','$descrpt','$startingbid','$name','$regularprice',NOW(),'$duedate',0)") or die(mysqli_error($conn));
...
<head>
	...
	<title>Bid Fare - Administrator</title>
		...
		<div id="bgwrap">
			...
			<div id="primary_right">
				<div class="inner">
				 ...
				 <p><input type="text" name="auctiontime" class="namewidth"/></p>
                                 <br/>
